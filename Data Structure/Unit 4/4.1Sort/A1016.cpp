...
bool cmp(Record a, Record b)
{
	...
	if (s != 0)return s < 0;	//���Ȱ����ֵ��˳���������
	else if (a.month != b.month)return a.month < b.month;	//�����·ݵ�˳���С�����������
	else if (a.dd != b.dd)return a.dd < b.dd;				//�������ڴ�С�����������
	else if (a.hh != b.hh)return a.hh < b.hh;				//����Сʱ��С�����������
	else return a.mm < b.mm;				//���շ��Ӵ�С�����������
}
...
int main() {
	...
	while (on < n) {
		...
		while (on < next) {
			...
			AllMoney += money;			//�ܽ����ϸôμ�¼��Ǯ
			printf("%d $%.2f\n", time, money / 100.0);
			on = off + 1;						//���һ������Դ�off+1��ʼ����һ��
		}
